...
```mermaid
flowchart LR
    A[Week 0-1<br/>Discovery and readiness audit] --> B[Week 1-2<br/>Use-case prioritization and success metrics]
    B --> C[Week 2-3<br/>Leadership enablement and governance baseline]
    C --> D[Week 3-6<br/>Pilot build and integration]
    D --> E[Week 5-6<br/>Validation, testing, and champion coaching]
    E --> F[Week 6-8<br/>Pilot review and rollout decision]
    F --> G[Week 8-12<br/>Team rollout, documentation, office hours]
    G --> H[Month 4+<br/>Optimization, KPI reviews, and expansion]
```
